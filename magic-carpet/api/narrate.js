...
TEXT: 一段90-130字的沉浸式中文冥想旁白。要求：第一句必须少于15字（如"风，托起了魔毯。"）；语调极度温柔缓慢如呢喃；先用15-25字描绘移动体感（风、云、水流、失重、速度）；再用70-90字描写到达${destination}的感官细节（看到的颜色光线、听到的声音、闻到的气息、皮肤的温度触感）；其中必须安排至少一个"主角时刻"——让世界主动与听众互动，比如一条鱼跃到你面前、一滴水落在你脸上、孙悟空拉起你的手带你飞、有人轻声对你说一句话——听众是故事的主角而不只是旁观的游客，但也不要每句都是互动，观景与互动交替；如有神话人物（嫦娥、孙悟空、龙王等）、科幻元素或著名地标自然融入；结尾一句10-15字以温柔的邀请或提问收束；每句都短，用句号或省略号断句
